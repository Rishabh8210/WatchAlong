...
const SignupMain = () => {
    ...
    return (
        <div className='min-h-[40vh] w-full md:w-2/5 p-5 rounded-md border-2 flex justify-center items-center bg-zinc-900 border-zinc-700'>
            <form className="h-fit w-full flex flex-col justify-center items-center gap-3">

                <div className="h-fit w-full flex justify-center items-center flex-col">
                    <p className="px-4 md:px-6 w-full font-semibold">Name</p>
                    <input
                        type="text"
                        className="h-10 w-11/12 text-gray-300 px-3 rounded-lg bg-black bg-opacity-45 border-2 border-zinc-600 outline-none focus:border-blue-600"
                        name="name"
                        value={name}
                        // placeholder="name"
                ...
                <div className="h-fit w-full flex justify-center items-center flex-col">
                    ...
                    <input
                        type="password"
                        className="h-10 w-11/12 px-3 text-gray-300 rounded-lg bg-black bg-opacity-45 border-2 border-zinc-600 outline-none focus:border-blue-600"
                        name="password"
                        value={password}
