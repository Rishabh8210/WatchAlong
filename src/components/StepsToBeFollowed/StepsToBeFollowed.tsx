...
const StepsToBeFollowed = () => {
  return (
    <div className='h-[60vh] w-full flex flex-col justify-around items-center'>
        <div className='h-full w-full sm:w-10/12 md:w-9/12 lg:max-w-3xl flex flex-col justify-around items-center p-5 gap-2 '>
            <Header />
